    ...
    var o = function() {
        ...
        (t = [{
            ...
            value: function() {
                ...
                n.config.useContainerInlineStyles && (i.style.position = "relative",
            ...
            key: "_createTextItem",
            value: function(e) {
                var t, n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0, i = this, o = document.createElement("span");
                return o.className = i.config.itemClass,
                i.config.useItemInlineStyles && (o.style.willChange = "transform, opacity, filter",
            ...
            value: function() {
                var e, t, n, a, r = this;
                r.paused || (r.keep || r.active || (r.mouseX = Math.abs(r.mouseX - r.mouseX0) < 1 ? r.mouseX0 : (r.mouseX + r.mouseX0) / 2,
                ...
                Math.abs(e) <= .01 && Math.abs(t) <= .01 || (n = Math.PI / 180,
            ...
            value: function(e) {
                ...
                i.texts.forEach(function(e, t) {
                    var n = i.items[t];
                    n || (a(n = i._createTextItem(e, t), i._computePosition(t, !0)),
